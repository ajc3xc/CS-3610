...
def receive_one_ping(
    my_socket: socket.socket, ID: int, timeout: int, dest_addr: str
) -> str:
    """
...
def send_one_ping(my_socket: socket.socket, dest_addr: str, ID: int) -> None:
    """
...
def do_one_ping(dest_addr: str, timeout: int) -> str:
    """
